    ...
    return (
        <div className='text-black relative'>
            <div className='pb-4  bg-[#EFD9CA] '>
                <h1 className='shadow-lg font-bold text-xs rounded-2xl px-2 py-1 bg-[#000300] text-[#EFD9CA] w-[80px] grid place-content-center absolute top-2 left-4 cursor-pointer'>Apple News</h1>
                <div className=' py-4'>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-3'>
                    {loading ? (<div className='flex justify-center items-center flex-col h-[50vh]'>
                        <ThreeCircles
                            height="100"
                            width="100"
                            color="#000300"
